...
- **Hardware Detection:** Real-time retrieval of CPU model, RAM capacity (for 64-bit systems and 32-bit systems), and GPU name.
- **Advanced Task Manager:** View the top 12 processes by memory usage and terminate unresponsive apps by Name or PID.
- **System Maintenance:** cleanup to empty the Recycle Bin and wipe temporary system files.
- **Quick Links:** Instant access to the hidden Windows "All Apps" folder and the System Settings menu.
- **UI Customization:** Cycle through various terminal color themes from the menu.
...
2. **Right-click** the file and select **Run as Administrator** (Required for Maintenance and Task managing features).
...
This script is designed with privacy:
